...
target = "http://127.0.0.1:8080" #specify target url
usernames = ["admin", "username", "test"] #specify usernames 
passwords = "/usr/share/wordlists/seclists/Passwords/2020-200_most_used_passwords.txt" #Specify wordlist
